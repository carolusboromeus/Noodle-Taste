...
<body class="background">
    ...
    <div class="nav-border-bottom container-fluid">
        <div class="center">
            <h3 class="nav-p">Contact Us</h3>
            <h2 id="nav-judul">Untuk menghubungi kami</h2>
        </div>
      <div class="row center">
          <div class="col-sm-6">
                <form method = "post" class="post">
                    Email Anda : <input type = "text" name = "email" placeholder = "Email :"><br>
                    Komentar : <br><textarea rows = "12" name = "textarea" id = "textarea" cols = "35" wrap = "virtual"></textarea><br>
                    <input name="Submit" type = "submit" onclick = "Kirim()" value = "Kirim"/>
                    <input name="Clear" type = "reset" value = "Batal"/>
                </form>
          </div>
          <div class="col-sm-6">
                <p class="info"><img src="./Icon/Whatsapp Icon v2.png" width="35" height="35"><span class="footer-p"> 021 &ndash; 780 8080</span></p>
                <p class="info"><img src="./Icon/Gmail Icon v2.png" width="35" height="35"><span class="footer-p"> order_noodletaste@noodletaste.co.id</span></p>
                <p class="info"><img src="./Icon/Map Marker Icon v2.png" width="35" height="35"><span class="footer-p"> Jl.Sunter Agung I No.06 Sunter, Jakarta Utara - Indonesia</span></p>
          </div>
      </div>
    </div>
