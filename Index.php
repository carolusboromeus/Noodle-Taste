...
<body class="background">
  ...
  <div class="nav-border-bottom container-fluid">
    <div class="center">
      <h3 class="nav-p">Selamat datang di noodle taste</h3>
    </div>
    <div class="row center">
        <div class="col-sm-6">
            <h2 id="nav-judul">Apa itu Noodle Taste?</h2>
        </div>
        <div class="col-sm-6">
            <p class="info">Toko produk yang menyediakan berbagai macam-macam makanan noodle dengan berbagai citra rasa bumbu-bumbu nusantara dan berbagai aneka macam minuman.</p>
            <p class="info" id="info-detail"><a href="./About.php" class="info-link">Info detail <i class="fa fa-angle-double-right"></i></a></p>
        </div>
    </div>
  </div>
