...
<style>
  ...
  <body class="background">
    ...
    <div class="nav-border-bottom container-fluid">
        <div class="center">
            <h3 class="nav-p">About Us</h3>
        </div>
      <div class="row center">
          <div class="col-sm-6">
              <h2 id="nav-judul">Noodle Taste adalah Mie Special</h2>
          </div>
          <div class="col-sm-6">
              <p class="info">Toko kami yang ada di jalan Sunter Agung I no 6, menyediakan berbagai macam jenis bakmie yang istimewa seperti : <em>pan fried noodle, pho noodle, black bean noodle, </em><em>soft ramen noodle</em> dan berbagai jenis bakmie lain yang kami sajikan dengan higienis dan harga yang terjangkau.</p>
              <p class="info" id="info-detail"><a href="./Menu.php" class="info-link">Pilihan Menu <i class="fa fa-angle-double-right"></i></a></p>
          </div>
      </div>
    </div>
